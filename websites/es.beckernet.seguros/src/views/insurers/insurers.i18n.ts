...
export const translations = {
  ...
  seo: {
    title: {
      es: "Aseguradoras | Becker Insurance Broker",
      de: "Versicherungsgesellschaften | Becker Insurance Broker",
      en: "Insurance Companies | Becker Insurance Broker",
    },
    description: {
      es: "Trabajamos con las principales aseguradoras del mercado: Allianz, AXA, Mapfre, Generali, DKV y muchas más.",
      de: "Wir arbeiten mit den führenden Versicherungsgesellschaften zusammen: Allianz, AXA, Mapfre, Generali, DKV und viele mehr.",
      en: "We work with the leading insurance companies: Allianz, AXA, Mapfre, Generali, DKV and many more.",
    },
  },
  hero: {
    label: {
    ...
    headline: {
      es: "Aseguradoras con las que trabajamos",
      de: "Versicherungsgesellschaften, mit denen wir arbeiten",
      en: "Insurance companies we work with",
    },
  },
  insurers: {
    allianz: {
      name: "Allianz",
      description: {
        es: "Fundada en 1890 en Berlín, Allianz es una de las aseguradoras más grandes del mundo. La empresa ofrece soluciones integrales desde salud, vida hasta seguros industriales y financieros. Con presencia en más de 70 países, Allianz lidera a través de la innovación y la sostenibilidad, con un enfoque firme en el uso de tecnologías de vanguardia.",
        de: "1890 in Berlin gegründet, zählt Allianz zu den weltweit größten Versicherern. Das Unternehmen bietet umfassende Lösungen von Gesundheit über Leben bis zu Industrie- und Finanzversicherungen. Mit Präsenz in über 70 Ländern führt Allianz durch Innovation und Nachhaltigkeit, mit fokussiertem Einsatz modernster Technologien.",
        en: "Founded in 1890 in Berlin, Allianz is one of the world's largest insurers. The company offers comprehensive solutions from health and life to industrial and financial insurance. With presence in over 70 countries, Allianz leads through innovation and sustainability, with focused use of cutting-edge technologies.",
      },
    },
    asisa: {
      name: "ASISA",
      description: {
        es: "Fundada en 1971, esta aseguradora de salud española es pionera con una estructura cooperativa dirigida por médicos. ASISA cuenta con redes propias de clínicas y ha ampliado su oferta para incluir seguros dentales y de vida.",
        de: "1971 gegründet, fungiert diese spanische Krankenversicherung als Pionier mit ärztlich geleiteter Genossenschaftsstruktur. ASISA verfügt über Eigennetze von Kliniken und hat seine Angebote um Zahn- und Lebensversicherungen erweitert.",
        en: "Founded in 1971, this Spanish health insurer is a pioneer with a cooperative structure led by doctors. ASISA has its own network of clinics and has expanded its offerings to include dental and life insurance.",
      },
    },
    axa: {
      name: "AXA",
      description: {
        es: "Fundada en 1817 en Francia, AXA evolucionó de una mutua de seguros local a un grupo financiero global. La empresa opera internacionalmente con una amplia gama de productos y apuesta por la transformación digital y la responsabilidad medioambiental.",
        de: "1817 in Frankreich gegründet, entwickelte sich AXA vom lokalen Versicherungsverein zum globalen Finanzkonzern. Die Gesellschaft operiert international mit breitem Produktspektrum und setzt auf digitale Transformation sowie Umweltverantwortung.",
        en: "Founded in 1817 in France, AXA evolved from a local insurance mutual to a global financial group. The company operates internationally with a wide range of products and focuses on digital transformation and environmental responsibility.",
      },
    },
    divina: {
      name: "Divina Seguros",
    ...
    dkv: {
      name: "DKV",
      description: {
        es: "Fundada en 1928 en Alemania, DKV se expandió a España en 1998. El enfoque está en la atención sanitaria, la sostenibilidad y la orientación digital con una oferta de productos diversificada.",
        de: "1928 in Deutschland gegründet, expandierte DKV 1998 nach Spanien. Der Schwerpunkt liegt auf Gesundheitswesen, Nachhaltigkeit und digitaler Ausrichtung mit diversifiziertem Produktangebot.",
        en: "Founded in 1928 in Germany, DKV expanded to Spain in 1998. The focus is on healthcare, sustainability and digital orientation with a diversified product offering.",
      },
    },
    euroins: {
      name: "Euroins",
...
export type InsurersTranslations = FlattenTranslation<typeof translations>;
