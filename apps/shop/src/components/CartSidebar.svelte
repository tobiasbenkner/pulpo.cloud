...
{:else}
    ...
    >
      {#if entries.length === 0}
        ...
        >
          ...
          <span class="text-xs font-medium">Leer</span>
        </div>
      {:else}
          ...
          >
            <div class="flex-1 min-w-0 pr-3">
              ...
              <div class="flex items-center gap-2">
                ...
                >
                  {info.hasDiscount ? info.discountLabel : "+ Rabatt"}
                </button>
              </div>
            </div>
  ...
  >
    ...
    <div class="space-y-1 mb-4">
      ...
      >
        <span class="text-zinc-900 font-bold text-xl">Gesamt</span>
        <span
    ...
    <div class="flex flex-col gap-3">
      ...
      >
        ...
        <span>{hasDiscount ? "Rabatt bearbeiten" : "Rabatt"}</span>
      </button>
